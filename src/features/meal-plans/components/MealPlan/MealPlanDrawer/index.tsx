...
import { useFetchSingleMealPlan } from '@/features/meal-plans/api/useFetchSingleMealPlan';
import { Skeleton } from '@/components/ui/Skeleton';
import { MealPlanDay } from '@/types/mealPlanDay';
import { useFetchRecipies } from '@/features/recipes/api/useFetchRecipies';
import { UpdateMealPlanInput, useUpdateMealPlan } from '@/features/meal-plans/api/useUpdateMealPlan';
import { MEAL_DRAWER_HEADING } from '../lib/dateFormats';
import { uppercaseFirstLetter } from '@/utils/uppercaseFirstLetter';
import {
  CreateBulkMealPlansInput,
  useCreateBulkMealPlans
} from '@/features/meal-plans/api/useCreateBulkMealPlans';
import { Empty } from '@/components/ui/Empty';
import { useDeleteMealPlan } from '@/features/meal-plans/api/useDeleteMealPlan';
    ...
    <div className='flex flex-col gap-4 py-4'>
      ...
      {meal.recipe && (
        <Item variant='outline' asChild>
          <Link to={PATHS.app.recipe.getHref(meal.recipe.id)}>
            <ItemContent>
